      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  ...
                  TextButton(
                    child: Text(
                      'view_all'.tr,
                      style: AppTextStyles.viewAllSubjectsTextStyle.copyWith(),
                    ),
                    onPressed: () {
                    ...
                    child: SubjectCard(
                      onTap: () {
                        Get.toNamed(
                          AppRoutes.subject,
                          arguments:
                              AppConstants.availableSubjects[index].title,
                        );
                      },
                      title: AppConstants.availableSubjects[index].title,
                      topicsCount: AppConstants
                          .availableSubjects[index].numberOfTopics
                          .toString(),
                      image: AppConstants.availableSubjects[index].image,
                    ),
                  );
                },
            ...
            const StreakWidget(streakText: '5/7', percentage: 5 / 7),
            Padding(
