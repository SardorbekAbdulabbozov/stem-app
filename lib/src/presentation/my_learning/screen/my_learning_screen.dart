          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                          ...
                          child: SubjectCard(
                            onTap: () {
                              Get.toNamed(AppRoutes.subject,
                                  arguments:
                                      ctr.mySubjects[index].subjectNameUz);
                            },
                            title: ctr.mySubjects[index].subjectNameUz ?? '',
                            topicsCount:
                                ctr.mySubjects[index].topicCount.toString(),
                            image: (ctr.mySubjects[index].subjectNameEn ?? '')
                                .toLowerCase(),
                          ),
                        );
                      },
                ...
                if (ctr.mySubjects.isEmpty)
                  Center(
                    child: Padding(
                      padding: const EdgeInsets.only(top: 32),
                      child: Text(
                        'Siz hech qaysi fanga ro`yxatdan o`tmagansiz',
                        style: AppTextStyles.chatbotMessageTextStyle
                            .copyWith(color: AppColors.filledIconColor),
                      ),
                    ),
                  ),
                Visibility(
